...
const Contacts = () => {
    ...
    return(<div className="d-flex flex-column align-items-center">
       ...
       <div className="d-flex flex-column align-items-start" style={{borderBottom:"1px solid white", borderTop:"1px solid white", padding:"10px"}}>
        ...
        <p><span style={{borderRadius:"50%", backgroundColor:"grey"}}><MailOutlineIcon style={{animation:"none", paddingBottom:"5px"}}></MailOutlineIcon></span> <a href="mailto:samuele.rusco@gmail.com" style={{ textDecoration: 'none', color: 'inherit' }}> samuele.rusco@gmail.com</a></p>
